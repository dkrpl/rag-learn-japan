...
- **Durable AI Question Pipeline**: Worker berbasis Redis untuk membuat soal reading pilihan ganda dari PDF material dengan retry dan observability. (Gate 6, disederhanakan untuk MVP PDF)
