...
from app.models.ai_jobs import AuditLog, GenerationJob, JobStatus, JobType
from app.models.user import User, UserRole
from app.schemas.ai_jobs import AudioJobCreate, GenerationJobCreate, GenerationJobResponse
...
def create_generation_job(
    job_in: GenerationJobCreate, db: Session = Depends(get_db), current_user: User = Depends(get_current_user)
):
    job = GenerationJob(
...
def create_audio_job(
    job_in: AudioJobCreate, db: Session = Depends(get_db), current_user: User = Depends(get_current_user)
):
    job = GenerationJob(
